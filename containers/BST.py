...
class BST(BinaryTree):
    ...
    That means that the BST class "inherits" all of the methods from BinaryT
    ree,
    ...
    def _is_bst_satisfied(node):
        ...
        it only checks if the children of the current node are less than/gre
        ater than,
        rather than ensuring that all nodes to the left/right are less than/
        greater than.

        HINT:
        Use the _find_smallest and _find_largest functions to fix the bug.
        You should use the _ prefixed methods because those are static metho
        ds just like this one.
        '''
        ret = True
        if node.left:
    ...
    def insert(self, value):
        ...
        HINT:
        Create a staticmethod helper function following the pattern of _is_b
        st_satisfied.
        '''
        if not self.root:
    ...
    def insert_list(self, xs):
        ...
        You cannot get this method to work correctly until you have gotten i
        nsert to work correctly.
        '''
        for i in xs:
            self.insert(i)
    ...
    def _find_smallest(node):
        '''
        This is a helper function for find_smallest and not intended to be c
        alled directly by the user.
        '''
    ...
    def remove(self, value):
        ...
        HINT:
        You should have everything else working before you implement this fu
        nction.
    ...
    def _remove(value, node):
        ...
        if node.value == value:
            if node.left is None:
                ...
                minright = BST._find_smallest(node.right)
                node.value = minright
                node.right = BST._remove(minright, node.right)
                return node
